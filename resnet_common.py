...
from keras.layers import MaxPooling2D, ZeroPadding2D, Reshape, Lambda, Dense
from keras.layers import GlobalAveragePooling2D, GlobalMaxPooling2D, DepthwiseConv2D
...
def block3(x, filters, kernel_size=3, stride=1, groups=32,
    ...
    output_shape = x_shape + (groups, c) if K.backend() == 'theano' else None
...
if __name__ == '__main__':
    model = ResNet152V2(input_shape=(224,224,3), include_top=False, weights='imagenet')
#    model.summary()